...
def ping(dest_addr, timeout):
    ...
    if "://" in dest_addr:
        dest_addr = dest_addr[dest_addr.find(':')+3:]
        # dest_addr.replace('http://', '')
...
def run():
    if not admin.isUserAdmin():
        ...
        print ping("https://futurism.com/new-research-shows-that-time-travel-is-mathematically-possible/", 2)
        # print ping("190.213.99.26:8080", 2)
        # print ping("190.213.99.26", 2)
